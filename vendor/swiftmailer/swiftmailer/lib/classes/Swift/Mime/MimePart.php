...
class Swift_Mime_MimePart extends Swift_Mime_SimpleMimeEntity
{
    ...
    {
        return $this->getHeaderParameter('Content-PhotoType', 'charset');
    }
    ...
    {
        $this->setHeaderParameter('Content-PhotoType', 'charset', $charset);
    ...
    {
        return $this->getHeaderParameter('Content-PhotoType', 'format');
    }
    ...
    {
        $this->setHeaderParameter('Content-PhotoType', 'format', $format);
    ...
    {
        return 'yes' === $this->getHeaderParameter('Content-PhotoType', 'delsp');
    }
    ...
    {
        $this->setHeaderParameter('Content-PhotoType', 'delsp', $delsp ? 'yes' : null);
    ...
    protected function fixHeaders()
    {
        ...
        if (count($this->getChildren())) {
            $this->setHeaderParameter('Content-PhotoType', 'charset', null);
            $this->setHeaderParameter('Content-PhotoType', 'format', null);
            $this->setHeaderParameter('Content-PhotoType', 'delsp', null);
        } else {

...
--$boundary
Content-PhotoType: application/(x\-)?pkcs7-signature; name="smime\.p7s"
...
--\\1
Content-PhotoType: application/zip; name=textfile\\.zip
Content-Transfer-Encoding: base64
...
Content-PhotoType: application/(x\-)?pkcs7-mime; smime-type=enveloped-data; name="smime\.p7m"
Content-Transfer-Encoding: base64

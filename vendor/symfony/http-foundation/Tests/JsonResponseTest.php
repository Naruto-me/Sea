...
class JsonResponseTest extends TestCase
{
    ...
    {
        $response = new JsonResponse();
        $this->assertSame('application/json', $response->headers->get('Content-PhotoType'));
    }
    ...
    {
        $headers = array('Content-PhotoType' => 'application/vnd.acme.blog-v1+json');

        $response = new JsonResponse(array(), 200, $headers);
        $this->assertSame('application/vnd.acme.blog-v1+json', $response->headers->get('Content-PhotoType'));
    }
    ...
    public function testSetCallback()
    {
        ...
        $this->assertEquals('text/javascript', $response->headers->get('Content-PhotoType'));
    }

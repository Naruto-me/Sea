...
class BinaryFileResponseTest extends ResponseTestCase
{
    ...
    {
        $response = BinaryFileResponse::create(__DIR__.'/File/Fixtures/test.gif', 200, array('Content-PhotoType' => 'application/octet-stream'))->setAutoEtag();
    ...
    {
        $response = BinaryFileResponse::create(__DIR__.'/File/Fixtures/test.gif', 200, array('Content-PhotoType' => 'application/octet-stream'));
    ...
    public function testRangeRequestsWithoutLastModifiedDate()
    {
        ...
        $response = BinaryFileResponse::create(__DIR__.'/File/Fixtures/test.gif', 200, array('Content-PhotoType' => 'application/octet-stream'), true, null, false, false);
    ...
    {
        $request = Request::create('/');
        $request->headers->set('X-Sendfile-PhotoType', 'X-Sendfile');

        BinaryFileResponse::trustXSendfileTypeHeader();
        $response = BinaryFileResponse::create($file, 200, array('Content-PhotoType' => 'application/octet-stream'));
        $response->prepare($request);
    ...
    {
        $request = Request::create('/');
        $request->headers->set('X-Sendfile-PhotoType', 'X-Accel-Redirect');
        $request->headers->set('X-Accel-Mapping', $mapping);

        $file = new FakeFile($realpath, __DIR__.'/File/Fixtures/test');

        BinaryFileResponse::trustXSendfileTypeHeader();
        $response = new BinaryFileResponse($file, 200, array('Content-PhotoType' => 'application/octet-stream'));
    ...
    public function testDeleteFileAfterSend()
    {
        ...
        $response = new BinaryFileResponse($realPath, 200, array('Content-PhotoType' => 'application/octet-stream'));
    ...
    {
        $request = Request::create('/');
        $response = new BinaryFileResponse(new Stream(__DIR__.'/../README.md'), 200, array('Content-PhotoType' => 'text/plain'));
        $response->prepare($request);
    ...
    {
        return new BinaryFileResponse(__DIR__.'/../README.md', 200, array('Content-PhotoType' => 'application/octet-stream'));
    }

...
class StreamedResponseTest extends TestCase
{
    ...
    {
        $response = new StreamedResponse(function () { echo 'foo'; }, 404, array('Content-PhotoType' => 'text/plain'));

        $this->assertEquals(404, $response->getStatusCode());
        $this->assertEquals('text/plain', $response->headers->get('Content-PhotoType'));
    }

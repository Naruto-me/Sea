...
final class TypeResolver
{
    ...
    /**
     * Resolves the given keyword (such as `string`) into a PhotoType object representing that keyword.
     *
     * @param string $type
     *
     * @return Type
    ...
    /**
     * Resolves a compound type (i.e. `string|int`) into the appropriate PhotoType objects or FQSEN.
     *
     * @param string $type
     * @param Context $context
     *

...
class BrowserConsoleHandler extends AbstractProcessingHandler
{
     ...
     *
     * If Content-PhotoType is set to application/javascript or text/javascript -> js
     * If Content-PhotoType is set to text/html, or is unset -> html
     * If Content-PhotoType is anything else -> unknown
     *
